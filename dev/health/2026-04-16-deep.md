...
## Summary
- Findings: 13  (critical: 0  warnings: 1  info: 12)
- Action required: NO
...
12. QC calibration: could not extract verdict from `dev/reviews/support-floor-stops.md`
...
- QC calibration findings: 4 (dune available: false)
...
Baseline: `2026-04-14-deep.md`

| File | Today | Prev (2026-04-14) | Delta |
|---|---|---|---|
| `data-layer.md` | 4 | — | (new) |
| `harness.md` | 4 | — | (new) |
| `portfolio-stops.md` | 1 | — | (new) |
| `simulation.md` | 7 | — | (new) |
| `support-floor-stops.md` | 1 | — | (new) |

### CC distribution — now vs previous snapshot

No baseline CC snapshot (first run). Current distribution:
...
CC JSON written to: `cc-2026-04-16.json`
