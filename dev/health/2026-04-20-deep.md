# Health Report -- 2026-04-20 -- deep

## Summary
- Findings: 28  (critical: 0  warnings: 5  info: 23)
- Action required: NO
...
9. Near size limit: `trading/weinstein/strategy/lib/weinstein_strategy.ml` — 324 lines (declared-large, limit: 500)
10. QC calibration: `backtest-infra` has review (verdict: **APPROVED**) but no audit trail in `dev/audit/`
11. QC calibration: could not extract verdict from `dev/reviews/backtest-scale-3b.md`
12. QC calibration: could not extract verdict from `dev/reviews/backtest-scale-3c.md`
13. QC calibration: could not extract verdict from `dev/reviews/backtest-scale-3d.md`
14. QC calibration: could not extract verdict from `dev/reviews/backtest-scale.md`
15. QC calibration: `data-layer` has review (verdict: APPROVED) but no audit trail in `dev/audit/`
16. QC calibration: could not extract verdict from `dev/reviews/harness-stale-bookmarks.md`
17. QC calibration: could not extract verdict from `dev/reviews/harness.md`
18. QC calibration: `screener` has review (verdict: APPROVED) but no audit trail in `dev/audit/`
19. QC calibration: `short-side-strategy` has review (verdict: APPROVED) but no audit trail in `dev/audit/`
20. QC calibration: could not extract verdict from `dev/reviews/strategy-wiring-held-symbols.md`
21. QC calibration: could not extract verdict from `dev/reviews/strategy-wiring.md`
22. QC calibration: could not extract verdict from `dev/reviews/support-floor-stops.md`
23. Stale local jj bookmarks: 2 local-only candidate(s), 0 behind-origin bookmark(s) -- see ## Stale Local Bookmarks
...
- QC calibration findings: 13 (dune available: false)
...
## Size Violation Detail
  ...
  - `trading/weinstein/strategy/lib/weinstein_strategy.ml`: 324 lines (declared-large)
...
|---|---|---|
| `feat/backtest-scale-3e` | `lyztmwvr` | orchestrator: harness cap=2 + plan-first fresh-stack dispatch (budget utilization) (#456) |
| `ops/daily-2026-04-20` | `lyztmwvr` | orchestrator: harness cap=2 + plan-first fresh-stack dispatch (budget utilization) (#456) |
