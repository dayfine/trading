...
| [harness](harness.md) | IN_PROGRESS | harness-maintainer | — | self-test #2301 + deps-scan comment strip #2303 MERGED; next: allow-list positive fixture, then audit-script rewrite (8 defects) |
...
| [cleanup](cleanup.md) | IN_PROGRESS | code-health | — | #2285 + rename-detector pin #2302 MERGED; 6 open, next: linter_coverage (test files exempt from file-length limits) |
