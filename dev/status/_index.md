...
Last updated: 2026-04-28 (orchestrator reconcile — 23 PRs from 2026-04-27T17Z to 2026-04-28T08Z merged by maintainer + sister agents. Net effect: trade-audit track wraps as MERGED (PR-1..PR-5 #638/#642/#643/#646/#649/#651 all landed); hybrid-tier Option 1 (engine-pool PR-1..PR-5 #618/#626/#628/#632/#633) DONE — Option 2 daily-snapshot streaming stays P1; backtest-perf gains tier-2 nightly (#622), tier-3 weekly (#625), tier-4 release-gate at N=1000 (#635), `release_perf_report` exe (#629), tier-1 universe-path fix (#634), tier-4 fixtures-root mirror (#640); short-side-strategy fully wraps (live-cascade fix #623, full short cascade #630, Ch.11 spot-check #631) — track confirmed MERGED; new optimal-strategy plan landed (#650); new trade-audit cascade-rejection extension (#646) + post-rebase regression investigation (#647) + determinism+start-date-shift regression tests (#648). Two open PRs at end of run: #641 fix/split-day-mtm (maintainer-authored, in active investigation per body) + #652 feat/optimal-strategy-pr1 (orchestrator-dispatched, QC APPROVED, awaiting human merge). New rows added for trade-audit (MERGED) and optimal-strategy (READY_FOR_REVIEW). Schema fixes: hybrid-tier.md `PARTIAL_DONE` → `IN_PROGRESS`.)
...
| [optimal-strategy](optimal-strategy.md) | READY_FOR_REVIEW | feat-backtest | #652 (feat/optimal-strategy-pr1) | Plan landed 2026-04-28 (#650). PR-1 (Optimal_types data model + Stage_transition_scanner) dispatched + delivered + QC'd this run on `feat/optimal-strategy-pr1`. Combined verdict APPROVED (qc-structural reported NEEDS_REWORK on H3+A2; both findings investigated and overridden as documented in `dev/reviews/optimal-strategy.md`). 425 LOC lib + 517 LOC tests, 13/13 pass, quality score 4. Awaiting human merge of #652. Next: PR-2 (`Outcome_scorer` ~300 LOC) per plan §Phase B once PR-1 lands. |
...
| [simulation](simulation.md) | MERGED | — | — | One in-flight maintainer-authored fix outside the orchestrator dispatch surface: PR #641 `fix/split-day-mtm` (split-day mark-to-market on open positions; sp500 baseline 2020-08-27→08-31 equity-curve dip caught by `dev/notes/goldens-performance-baselines-2026-04-28.md`). Maintainer is investigating goldens drift on rebase against post-#645 main. Not a tracked work item; listed here for visibility only. |
