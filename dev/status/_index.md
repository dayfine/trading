...
Last updated: 2026-04-18 (orchestrator run 2)
...
|---|---|---|---|---|
| [backtest-infra](backtest-infra.md) | READY_FOR_REVIEW | feat-backtest | #419 (feat/backtest-phase-tracing) | Step 2 tracing landed (Trace module + runner wraps 5/11 phases) — awaiting QC. Then Step 3 tier-aware bar loader (backtest-scale track). |
...
| [short-side-strategy](short-side-strategy.md) | READY_FOR_REVIEW | feat-weinstein | #420 (feat/short-side-strategy) | MVP slice (plan + screener side-tagging + entry parameterisation + unit tests) — awaiting QC. Follow-ups: bear-window backtest regression, full short cascade, Ch.11 behavioural spot-check. |
