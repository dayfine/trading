...
| [backtest-infra](backtest-infra.md) | IN_PROGRESS | dayfine + feat-backtest | — | #2758 MERGED (prefix_misscale cut at build, `-cut-prefix-misscale`); next: #2732 asks 1+3 (MEL quarantine, item-3 re-run) — LOCAL/data-gated |
