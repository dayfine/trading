...
| [support-floor-stops](support-floor-stops.md) | IN_PROGRESS | feat-weinstein | — | empty-population %-absence pin MERGED #2239 `ec6f5ce6`; next: F11+F12+R3 test-hardening bundle, then F3 (needs golden re-pin) |
...
| [harness](harness.md) | IN_PROGRESS | harness-maintainer | — | H-RECORD-QC-AUDIT-REPO-ROOT-SIBLING MERGED `813a91e5` (#2243); next: H-REPO-ROOT-SET-BUT-INVALID-SILENT-FALLTHROUGH or H-REWORK-STREAK-ESCALATION-UNTESTED |
...
| [cleanup](cleanup.md) | IN_PROGRESS | code-health | — | F2 default_params pin CLOSED (landed via #2224 ops-PR sweep-in; gated retroactively, #2228 closed as no-op); next: adjusted_basis_guard_asymmetry or tracked_build_artifact |
