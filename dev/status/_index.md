...
| [support-floor-stops](support-floor-stops.md) | IN_PROGRESS | feat-weinstein | — | B5+B6 MERGED #2232 `b54f8880`; next: F3 raw-vs-adjusted in trade_audit_report_bin (needs golden re-pin) |
...
| [harness](harness.md) | IN_PROGRESS | harness-maintainer | — | H-AUDIT-TEST-DISABLE-COUNT-TAUTOLOGICAL + H-WRITE-AUDIT-REPO-ROOT MERGED `25d07cfc` (#2231); next: H-REWORK-STREAK-ESCALATION-UNTESTED or H-RECORD-QC-AUDIT-REPO-ROOT-SIBLING |
