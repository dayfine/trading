...
|---|---|---|---|---|
| [resistance-v2](resistance-v2.md) | IN_PROGRESS | dayfine (maintainer LOCAL) | #2002 | #2002 virgin hist-empty fix open: maintainer NEEDS_REWORK (doc-only), CI green, LOCAL; then WF-CV vs w30 (data-gated); R3 promotion human-gated |
