...
Last updated: 2026-04-19 (post-dispatch reconcile: #434/#435/#436 open)
...
| [backtest-scale](backtest-scale.md) | READY_FOR_REVIEW | feat-backtest | #434 | 3a QC APPROVED (structural + behavioral, quality 5) — awaiting human merge; next increment is 3b Summary tier. |
...
| [harness](harness.md) | READY_FOR_REVIEW | harness-maintainer | #435 | Deep-scan Check 11 (linter exception expiry) QC APPROVED — awaiting human merge. Next: deep-scan heuristic gaps sub-item 4 (stale local jj bookmarks); plus T3-A+ (move deep-scan to weekly cron; retire inline fast-scan). |
