...
- [x] design_doc_drift: docs/design/backtest-scale-optimization-2026-04-17.md — added a 23-subdir inventory appendix to `dev/plans/backtest-scale-optimization-2026-04-17.md` (the finding's stated path doesn't exist; no `docs/design/` file by this name — fixed the real one). PR TBD (2026-07-26)
