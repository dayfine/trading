...
- [~] design_doc_drift: docs/design/backtest-scale-optimization-2026-04-17.md — 23 `trading/trading/backtest/*` subdirs exist on disk but are unmentioned (all_eligible, barbell, bin, cost_model, decision_audit, decision_grading, experiment_ledger, feature_screen, fork_pool, optimal, readme_toplines, release_report, rolling_start, runner_args, snapshot_warehouse, stats, sweep_weekly_start, trade_audit_html, trade_audit_report, tuner, validation, walk_forward, warmup_gate) (source: 2026-07-20-deep.md, warnings 7-29) — note: the actual file is `dev/plans/backtest-scale-optimization-2026-04-17.md` (no such file exists under docs/design/); the finding's path prefix appears mis-transcribed, fixing the file that actually exists
