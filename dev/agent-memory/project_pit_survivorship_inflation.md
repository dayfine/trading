...
**2026-09-08 measured directly on the 2019 vintage (top-3000, same spec, same build, paired salts):** survivor-tilted warehouse (2,209 names) 32.2–46.1% vs gap-filled (2,936 names, 1,247 of the added names dead at real dates) 20.5–22.9% on 2019–2023 → **−12 to −23pp of 5y return, +2pp maxDD**; mechanism = displacement of which breakouts win the top-N slots (same arm-only names at every salt), not the dead names' own trades (−$42–55k per salt, 18–19 trades). See `dev/experiments/warehouse-rebuild-2026-09-06/README.md` §"The survivorship cost as a BAND". Related: [[warehouse-vintage-coverage]].
