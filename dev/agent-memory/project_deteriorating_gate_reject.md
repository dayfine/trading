...
description: "deteriorating_blocks_longs (#2755/#2759, default-off) REJECT-do-not-revive on 09-13: 3 salts on _v10dedup vs the a0-v10 band, V6=0 — realised −$1.70M / −$0.82M / −$1.25M (0/3), maxDD worse/worse/better (1/3, the win on the null's $3.84M open-MTM cell). Deteriorating fires INSIDE recoveries (6 wks 2020, 20 wks 2022–23) and removes NVDA 2020-04-06 / UTHR 2020-12-02 / BBWI 2020-08-08 at 2–3 salts each. Closes the state-conditioning line from the 09-04 yearly review. Ledger 2026-09-13-deteriorating-breadth-long-gate."
metadata:
  type: project
  modified: 2026-09-13
---
...
also on; the rework threaded `~macro_trend` so the gate is a pure conjunct. Flag stays default-off; Rule-4
retirement candidate after three sessions.
