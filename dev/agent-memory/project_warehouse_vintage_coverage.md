...
**2026-09-08 04:17 — the tilt MEASURED (salt 0):** rec5y-2019 on `_v9gap` (2,936 names) = 21.67% / 181 / Sharpe 0.30 / DD 23.6, V16/V17 clean, vs 42.37% / 175 / 0.50 / 21.7 on `_v7mark` (2,209). Join: 111 shared trades earn MORE on v9gap; the gap is v7-only +$195k (BBWI, AN) vs v9-only −$8k (BBBY, ZS + losers); only 18 v9-only trades sit on the 727 widened names (−$50k). Mostly PATH LOTTERY from a bigger candidate pool + a direct −$50k dilution. Salts 1–2 on both warehouses running (chain4.log); quote a band, never the −20pp. The 2019 5y cell in the 09-07 record is superseded by the `_v9gap` band.
