---
name: project_index_stage_veto_verdict
description: index_stage_veto_blocks_longs (book §2.1 Stage-4 index suspends buys) — REJECT-as-default / KEEP-AS-AXIS 2026-09-21; 3 salts on the PIT band, V6=0; realised 1/3, Calmar 3/3 but lower-peak artifact; earns in the 2022 grind, pays on the 2020 V-recovery, both 3/3
metadata:
  type: project
---

**Verdict (2026-09-21, ledger `2026-09-21-index-stage-veto.sexp`, README
`dev/experiments/index-stage-veto-2026-09-16/`):** REJECT-as-default, keep as
axis. `index_stage_veto_blocks_longs` stays default-off. Pre-registered rule
(realised AND Calmar at ≥ 2/3 salts) — only salt 1 clears both. Not
do-not-revive: book-faithful (#2861 write-back), does exactly what it says.

| salt | realised null → arm | maxDD | Calmar |
|---|---|---|---|
| 0 | $3.85M → $2.77M fail | 40.6 → 33.5 | 0.165 → 0.173 |
| 1 | $1.67M → $2.66M clear | 53.0 → 40.6 | 0.077 → 0.135 |
| 2 | $1.40M → $0.97M fail | 51.3 → 46.2 | 0.069 → 0.073 |

**The Calmar wins are mostly a lower peak** — the arm never makes the 2020–21
highs; at salt 2 its dollar trough is $0.54M *below* the null's on the same day.
