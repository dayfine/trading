...
;; re-runs the ENGINE leg on a genuinely broader universe — top-3000 PIT-2000
;; (~6x the SP500-515 breadth; the engine's documented strong-edge universe) — over the SAME window as grid cell A (2000-2026),
...
((name "engine-top3000-2000-deep")
 (description "Cell-E engine, top-3000 PIT-2000, 2000-2026 — barbell breadth-confirmation cell.")
 (period ((start_date 2000-01-01) (end_date 2026-04-30)))
 (universe_path "workspaces/trading-1/trading/test_data/goldens-custom-universe/composition/top-3000-2000.sexp")
 (universe_size 3000)
 (config_overrides
