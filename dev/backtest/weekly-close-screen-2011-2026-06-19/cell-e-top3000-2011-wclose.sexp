...
;; identical to cell-e-top3000-2011.sexp. Read-only: measures the
;; weekly-close stop dial vs the long-only deep baseline. Adds
;; ((stops_config ((trigger_on_weekly_close true)))).
((name "cell-e-top3000-2011-wclose")
 (description "Cell-E top-3000 PIT-2011, weekly-close stop ON, screen.")
