;; GRID Cell 2 — period-disjoint / universe-diverse recent. sp500-2015 PIT, 2015-2026.
;; A-D-inert (skip_ad_breadth=false). A-D-default confirmation grid (promotion-confirmation.md).
((name "cell3-2015-adinert")
 (description "GRID cell2 longshort A-D-inert, sp500-2015 PIT, 2015-2026.")
 (period ((start_date 2015-01-01) (end_date 2026-04-30)))
