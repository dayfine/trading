;; Weekly-close stop SCREEN (flag ON) — deep 1998-2026, long-only, otherwise
;; identical to cell-e-top3000-1998-deep.sexp. Read-only: measures the
;; weekly-close stop dial vs the long-only deep baseline. Adds
;; ((stops_config ((trigger_on_weekly_close true)))).
((name "cell-e-top3000-1998-deep-wclose")
 (description "Cell-E top-3000 PIT-1998 deep, weekly-close stop ON, screen.")
