...
| `g19-novol-s6` | +6.79% | 163 | 31.9% | +0.162 | 39.5% | both levers: +17pp vs base, below `s6` alone. Exit mix 70 laggard (+$991k) / 93 stop (−$1,023k); realised −$32k; no MSTR-class trade (it was ejected-then-held differently under eject-off). Salt-0 only. |
...
| both (`novol-s6`) | −$32k / 39.5% | −$155k / 30.3% (worst) | −$92k / 33.5% (worst) | **REJECT**: worst or near-worst realised and MaxDD in 3/3 windows. |
