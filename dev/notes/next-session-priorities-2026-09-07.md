...
guard-3 retirement (MERGED #2705, 5a6ff8137), #2696 (MERGED #2709, 077b48973), PR-B (MERGED #2708) + its correction #2713 (MERGED, closes #2711: reuse = report-only, cut by exception — the blanket cut would have gutted 247/518 series, see README §"Paired armed-splice rebuild"), gap fetch (DONE 09-08 02:42: 1,359 of 1,531 names fetched, 1,247 dead at real dates, 24 miss, TMS quarantined as a 2025 reuse; `_v9gap` 2009/2019 rebuilt 03:50; **survivorship cost MEASURED as a paired band 06:05: 2019 5y = 20.5–22.9% on `_v9gap` vs 32.2–46.1% on `_v7mark`, −12 to −23pp, deterministic displacement — PR #2717; the 09-07 2019 5y cell is superseded**); item 3 (per-state stop width, plan #2700) **MERGED #2718 (e7dde095a, 08:09 PT 09-08)** as the default-off axis `initial_stop_buffer_by_macro_state` (five slots, 0 = use the scalar; dot-path `initial_stop_buffer_by_macro_state.deteriorating=1.0`); NEXT = the surface: the candidate map (Bullish/Recovering 12% = 0.9167, Neutral 8–10%, Deteriorating/Bearish 4–6% = 1.0) on the 26y record spec, salted, vs the record band — a sweep, not a promotion; then items 3–4 of 09-06 (per-state
