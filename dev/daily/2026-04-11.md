...
- **ADL Phase B** — live coverage for 2020-02-11 → present. Candidates in `dev/notes/adl-sources.md` (StockCharts `$NYAD`, WSJ, Barchart, Nasdaq Data Link, FRED, Russell 3000 compute-from-universe). Needs human to pick.
