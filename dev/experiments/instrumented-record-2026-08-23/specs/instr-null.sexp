...
((name "instr-null")
 (description "Instrumented record-convention 26y null: fullbook-graded base verbatim (E-anchored StopLimit band 2pp + stop re-anchored to entry base), observability-only additions.")
