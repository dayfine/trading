...
((name "c1-conc25")
 (description "Probe arm c1: a0 null with max_position_pct_long 0.14 -> 0.25 (per-position concentration; exposure 0.70 and min_cash 0.30 unchanged)")
 ...
 (config_overrides
  (((enable_sim_entry_stoplimit true)) ((entry_order_max_rest_weeks 0))
   ...
   ((portfolio_config ((max_position_pct_long 0.25))))
