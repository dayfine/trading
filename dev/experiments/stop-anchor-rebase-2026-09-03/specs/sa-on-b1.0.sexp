;; STOP-ANCHOR SURFACE (#2408) — arm sa-on-b1.0.
;; Axes: stop_anchor_at_entry_base=true, initial_stop_buffer=1.0.
...
((name "sa-on-b1.0")
 (description "stop-anchor surface arm sa-on-b1.0 (#2408): anchor=true buffer=1.0")
