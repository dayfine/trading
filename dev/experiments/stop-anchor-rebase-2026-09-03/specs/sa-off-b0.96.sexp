;; STOP-ANCHOR SURFACE (#2408) — arm sa-off-b0.96.
;; Axes: stop_anchor_at_entry_base=false, initial_stop_buffer=0.96.
...
((name "sa-off-b0.96")
 (description "stop-anchor surface arm sa-off-b0.96 (#2408): anchor=false buffer=0.96")
