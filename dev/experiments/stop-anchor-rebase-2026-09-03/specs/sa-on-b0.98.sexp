;; STOP-ANCHOR SURFACE (#2408) — arm sa-on-b0.98.
;; Axes: stop_anchor_at_entry_base=true, initial_stop_buffer=0.98.
...
((name "sa-on-b0.98")
 (description "stop-anchor surface arm sa-on-b0.98 (#2408): anchor=true buffer=0.98")
