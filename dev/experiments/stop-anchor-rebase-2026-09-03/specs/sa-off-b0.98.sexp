;; STOP-ANCHOR SURFACE (#2408) — arm sa-off-b0.98.
;; Axes: stop_anchor_at_entry_base=false, initial_stop_buffer=0.98.
...
((name "sa-off-b0.98")
 (description "stop-anchor surface arm sa-off-b0.98 (#2408): anchor=false buffer=0.98")
