;; STOP-ANCHOR SURFACE (#2408) — arm sa-null-dup.
;; Axes: stop_anchor_at_entry_base=false, initial_stop_buffer=1.00.
...
;; DUPLICATE NULL CELL (ladder-v4 278pp lesson): semantically identical to
;;   sa-off-b1.0, spelled differently (name + 1.00 vs 1.0). Any spread between
;;   the two IS the same-cell noise floor at this base/salt.
((name "sa-null-dup")
 (description "stop-anchor surface arm sa-null-dup (#2408): anchor=false buffer=1.00")
