;; STOP-ANCHOR SURFACE (#2408) — arm sa-off-b1.0.
;; Axes: stop_anchor_at_entry_base=false, initial_stop_buffer=1.0.
...
((name "sa-off-b1.0")
 (description "stop-anchor surface arm sa-off-b1.0 (#2408): anchor=false buffer=1.0")
