...
((name "ttl-retest-02-ttl13")
 (description "TTL re-test: re-screen + 13-week clock (~91d) — the TOP of the 29-91d bucket rather than its lower edge.")
