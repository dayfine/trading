...
((name "ttl-retest-06-clock26-only")
 (description "Clock ALONE at 26 weeks: re-screen off, entry_order_max_rest_weeks 26. Isolates the time bound from the re-screen, which #2376 rejected at -137pp.")
