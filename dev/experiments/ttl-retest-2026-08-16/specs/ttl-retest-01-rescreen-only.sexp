...
((name "ttl-retest-01-rescreen-only")
 (description "TTL re-test: the book-supported re-screen cancel ALONE, clock unbounded. Unreachable before the #2349 knob split.")
