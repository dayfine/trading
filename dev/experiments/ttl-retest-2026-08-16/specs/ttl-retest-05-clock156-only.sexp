...
((name "ttl-retest-05-clock156-only")
 (description "TTL re-test: the defect-E absurdity bound ALONE (156w ~ 3y), re-screen off. Isolates the clock from the book-supported half.")
 ...
 (config_overrides
  (;; --- v2-core base (verbatim from the ladder-v3 faithful arm) ---
   ...
   ((entry_order_max_rest_weeks 156))
