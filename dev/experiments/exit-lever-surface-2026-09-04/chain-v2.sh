#!/bin/sh
# v2 (launched 17:00 PDT after salt 0): trimmed loop — see README "Chain trimmed".
...
# The v1 chain was stopped mid-way through the lagoff salt-1 pair; its two cell
# subshells keep running and will write their own RESULT lines. Wait for them
# (memory guard would refuse otherwise), then continue with the trimmed set.
until grep -q 'RESULT xl5y-2019-lagoff-s1 ' "$LOG_HOST" && grep -q 'RESULT xl5y-2000-lagoff-s1 ' "$LOG_HOST"; do sleep 30; done
log "v2 resume after lagoff-s1"
pair2 xl5y-2000-extoff 1   xl5y-2019-clock52 1
pair2 xl5y-2000-clock52 1  xl5y-2019-lagoff 2
log "SALT 1 COMPLETE"
pair2 xl5y-2000-lagoff 2   xl5y-2000-extoff 2
pair2 xl5y-2019-clock52 2  xl5y-2000-clock52 2
log "SALT 2 COMPLETE"
