;; Entry-caps 3-arm sweep: arm A = baseline (Cell E default, no caps).
((name "entry-caps-15y-arm-a-baseline")
 (description "Cell E 15y baseline — no max_score_override, no stop floor change")
