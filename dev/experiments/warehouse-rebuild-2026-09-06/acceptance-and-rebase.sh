...
set -u
C=trading-1-dev
WT=/workspaces/trading-1/.claude/worktrees/sweep-wh0906b   # merged main incl. #2692 (delisted exit + V16/V17)
ROOT=$WT/trading
FIX=$ROOT/test_data/backtest_scenarios
SPECS_HOST=/tmp/wh-rebuild/specs
WORK=/tmp/wh-run; ART=/tmp/sweeps/wh0906
LOG_HOST=/tmp/wh-rebuild/chain.log; LOCK=/tmp/wh-rebuild/chain.lock
W2000=/tmp/snap_top3000_2000_v6tail; W2019=/tmp/snap_top3000_2019_v6tail
CELL_TIMEOUT=28800
