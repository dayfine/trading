...
| 13 | Vintage gap fetch (§"Vintage gap fetch" below): 1,359 of 1,531 attempted names fetched (1,247 of them dead — real death dates); 24 MISS (ticker reused by a new listing, or a <200-row real series); 148 synthetic twins skipped; TMS (2025 listing) quarantined 03:25 | `fetch_gap.sh` | done 02:40 PT Sep 8 |
| 14 | Rebuild the 2009 / 2019 warehouses on the widened store (`rebuild4.sh` → `_v9gap`, #2691/#2695 build, splice detector OFF) | build | launched 03:08 PT Sep 8 |
