...
Consequence for the record: the 2019-vintage 5y cell in §Step 6 (42.37% / 175) was measured on the survivor-tilted warehouse and is superseded by the `_v9gap` band once the salts land; the 26y record (2000 vintage, 94% covered before the fetch) is unaffected.
