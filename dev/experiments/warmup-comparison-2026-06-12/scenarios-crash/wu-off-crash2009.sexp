...
;; OFF arm = current behavior (warmup trades; portfolio inherits GFC-depleted positions).
((name "wu-off-crash2009")
 (description "Warmup-compare OFF: crash-warmup 2009-07 start, top-1000-2008, CSV mode.")
