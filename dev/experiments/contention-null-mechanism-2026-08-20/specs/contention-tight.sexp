...
((name "contention-tight")
 (description "Contention test: 5y core with max_position_pct_long raised 0.14 -> 0.33 so the capital constraint binds.")
 ...
 (config_overrides
  (;; --- v2-core base (verbatim from the ladder-v3 faithful arm) ---
   ...
   ((portfolio_config ((max_position_pct_long 0.33))))
