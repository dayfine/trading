;; Item-3 surface arm (dev/experiments/stop-width-by-state-2026-09-08/README.md): the rec26y-new record spec
...
((name "a1-map-neutral8")
 (description "Item-3 surface: record + breadth read ON + per-state map bullish/recovering 0.9167 (12%), neutral 0.96 (8%), deteriorating/bearish 1.0 (4%)")
 ...
 (config_overrides
  (((enable_sim_entry_stoplimit true)) ((entry_order_max_rest_weeks 0))
   ...
   ((macro_config ((breadth_direction ((enabled true)))))) ((initial_stop_buffer_by_macro_state ((bullish 0.9167) (recovering 0.9167) (neutral 0.96) (deteriorating 1.0) (bearish 1.0))))))
