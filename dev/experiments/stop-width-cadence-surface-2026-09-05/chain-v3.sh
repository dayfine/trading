#!/bin/sh
# v3: 26y confirmation arms (w14-D, w12-W) after salts 1-2; waits BEFORE taking the lock.
...
until grep -q "SW0905 V2 DONE" "$LOG_HOST"; do sleep 30; done
...
log "v3 26y confirmation start"
run_cell sw26y-w14-D 0
run_cell sw26y-w12-W 0
log "SW0905 V3 DONE"
