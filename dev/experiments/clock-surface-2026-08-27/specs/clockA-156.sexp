...
((name "clockA-156")
 (description "clock-surface arm A-156 (#2405): record-baseline lineage, entry_order_max_rest_weeks=156")
 ...
 (config_overrides
  (((enable_sim_entry_stoplimit true)) ((entry_order_max_rest_weeks 156))
