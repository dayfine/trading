;; clock-surface arm (2026-08-27, #2405) — record-baseline lineage; — 26y broad record-convention
...
((name "clockD-52")
 (description "clock-surface arm D-52 (#2405 G2 cell): record-baseline lineage, breadth swapped to top-1000 PIT-2000, entry_order_max_rest_weeks=52")
 (period ((start_date 2000-01-01) (end_date 2026-06-26)))
 (universe_path "../goldens-custom-universe/composition/top-1000-2000.sexp")
 (universe_size 1000)
 ;; entry_order_max_rest_weeks is THE surface axis of this experiment
 ;; (clock-surface-2026-08-27, #2405): arms {0,13,26,52,156}, one knob diff
 ;; against the record-baseline lineage. Arm 0 is the fresh null at this build.
 (config_overrides
  (((enable_sim_entry_stoplimit true)) ((entry_order_max_rest_weeks 52))
