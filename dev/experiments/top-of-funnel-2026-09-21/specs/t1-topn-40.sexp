...
((name "t1-topn-40")
 (description "Top-N capacity arm: a0-pit-null + screening_config.max_buy_candidates 20 -> 40 (the screener returns up to 40 ranked long candidates per week instead of 20; grade, gates, sizing and slots unchanged); pairs against a0-pit-null-s{0,1,2}-v11")
