;; PIT record null (dev/plans/pit-universe-migration-2026-09-14.md step 4): the a0-breadth-on-null spec with the
;; year-2000 vintage universe replaced by a yearly universe_schedule (D1/D2: the list dated YYYY-05-31 governs
;; [YYYY-05-31, next); the 1999 entry governs Jan-May 2000). Runs on /tmp/snap_top3000_pit_v11pit.
;; NOT a golden - staging scenario.
((name "d0-funnel-diag")
 (description "Funnel-decomposition diagnostic: the a0-pit-null config UNCHANGED, run with --emit-candidates so candidates.sexp carries every week's cascade population and drop phase (Dropped_at_top_n, Dropped_at_breakout sub-reasons); trades.csv must be byte-identical to the committed a0-pit-null-s0-v11 (determinism tripwire)")
