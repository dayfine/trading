...
set -u
LANE=$1; shift
C=trading-1-dev; REPO=/Users/difan/Projects/trading-1; WTREL=.claude/worktrees/sweep-veto
...
LOG_HOST=/tmp/veto-run/chain-$LANE.log; LOCK=/tmp/veto-run/chain-$LANE.lock; CELL_TIMEOUT=36000
