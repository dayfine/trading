...
LOG_HOST=/tmp/dg0906-run/chain.log
SNAP=/tmp/snap_top3000_dedup_v5thin_adj
LOCK=/tmp/dg0906-run/chain.lock
...
# --- 5y-2019 pair on the 2019-vintage warehouse, two concurrent ---
require_disk "pre-5y-2019"; require_memory 4096 "pre-5y-2019"
( SNAP=$SNAP2019; run_cell dg-5y-2019-off ) & p1=$!
( SNAP=$SNAP2019; run_cell dg-5y-2019-on ) & p2=$!
wait $p1 $p2
log "PAIR dg-5y-2019 COMPLETE"

# --- 26y record, one arm at a time: off first (tripwire), then on ---
for arm in off on; do
  require_disk "pre-dg-26y-$arm"; require_memory 4096 "pre-dg-26y-$arm"
  run_cell dg-26y-$arm
done
log "DG0906 CHAIN DONE"
