;; BROAD deep long-only base for the scale-in v1 surface — top-3000-2000 PIT,
...
((name "scale-in-base-top3000")
 (description "BROAD deep long-only + catstop base for the scale-in v1 WF-CV (top-3000-2000 PIT, production caps).")
