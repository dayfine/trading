;; P2 — laggard h-sweep on 15y SP500: hysteresis_weeks = 6 (longest hold).
((name "laggard-h6-stage3-k1")
 (description
   "15y SP500 — Stage3 ON h=1 + Laggard ON h=6 (longer hysteresis; might hold winners longer). h-sweep variant.")
 ...
 (config_overrides
  (((enable_short_side false))
   ...
   ((laggard_rotation_config ((hysteresis_weeks 6))))))
 (expected
