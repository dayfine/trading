;; P2 — laggard h-sweep on 15y SP500: hysteresis_weeks = 2 (current Cell E).
((name "laggard-h2-stage3-k1")
 (description
   "15y SP500 — Stage3 ON h=1 + Laggard ON h=2 (Cell E baseline). h-sweep control.")
