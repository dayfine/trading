;; P2 — laggard h-sweep on 15y SP500: hysteresis_weeks = 4 (framing-note default).
((name "laggard-h4-stage3-k1")
 (description
   "15y SP500 — Stage3 ON h=1 + Laggard ON h=4 (framing-note default). h-sweep variant.")
