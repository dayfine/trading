;; Holding-period sweep: stage3_h=1, laggard_h=2 on Cell E 15y default.
((name "cell-e-15y-s1-l2")
 (description "Cell E 15y — stage3_force_exit_h=1, laggard_rotation_h=2")
