;; Holding-period sweep: stage3_h=0, laggard_h=4 on Cell E 15y default.
((name "cell-e-15y-s0-l4")
 (description "Cell E 15y — stage3_force_exit_h=0, laggard_rotation_h=4")
