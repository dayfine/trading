;; Holding-period sweep: stage3_h=2, laggard_h=3 on Cell E 15y default.
((name "cell-e-15y-s2-l3")
 (description "Cell E 15y — stage3_force_exit_h=2, laggard_rotation_h=3")
