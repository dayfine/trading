...
((name "p02-top3000-base")
 (description "P0.2 payoff baseline — top-3000, 2018-2023. Ladder v4 cell 00 (core-w4): anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.15 volume_confirm=false. the v2-core cell — every v4 knob at its no-op.")
 (period ((start_date 2018-01-02) (end_date 2023-12-29)))
 (universe_path "universes/broad-3000-2010-01-01.sexp")
 (universe_size 3000)
 (config_overrides
