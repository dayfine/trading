((checks
  (((id V1) (severity Invariant) (passed true) (n_violations 0) (n_skipped 0)
   ...
   ((id V9) (severity Expectation) (passed false) (n_violations 117)
    (n_skipped 250)
    (specimens
   ...
   ((id V12) (severity Invariant) (passed false) (n_violations 18)
    ...
    (specimens
     (((symbol WFM) (entry_date 2013-05-18)
      ...
      ((symbol SRZ) (entry_date 2004-11-23)
       (detail
        "installed_stop=38.1318 vs fill=21.7100 -> dist=0.7564 > gate=0.1500"))
      ...
      ((symbol INFY) (entry_date 2006-07-12)
       (detail
        "installed_stop=73.7467 vs fill=41.9200 -> dist=0.7592 > gate=0.1500"))
      ((symbol INFY) (entry_date 2014-10-10)
       (detail
        "installed_stop=55.8996 vs fill=31.7800 -> dist=0.7590 > gate=0.1500")))))
   ((id V13) (severity Invariant) (passed false) (n_violations 161)
    ...
    (specimens
     (((symbol WLL1) (entry_date 2002-01-22)
      ...
      ((symbol UN) (entry_date 2012-08-04)
       (detail
        "no bar on entry_date 2012-08-04 (nearest earlier bar: 2012-08-03)"))
   ...
   ((id V18) (severity Expectation) (passed false) (n_violations 5)
    ...
    (specimens
     (((symbol BRK-A) (entry_date 2006-05-18)
       (detail
        "median close 83000.10 over 11229 bars (1980-03-17..2026-06-12), above the 10000.00 ceiling"))
      ((symbol EHC) (entry_date 2010-01-13)
       (detail
        "median close 23.25 over 10006 bars (1986-09-24..2026-06-12); bar 2006-10-26 close 23.75 (+400.00% vs prior close 4.75) on volume 0"))
      ((symbol FLO) (entry_date 2007-04-13)
       (detail
        "median close 18.18 over 11655 bars (1980-03-17..2026-06-12); bar 2001-03-27 close 16.55 (+399.90% vs prior close 3.31) on volume 0"))
      ((symbol MVL) (entry_date 2002-03-08)
       (detail
        "median close 9.00 over 4795 bars (1999-01-04..2018-01-24); bar 2010-01-26 close 60.00 (+96.88% vs prior close 30.48) on volume 0"))
      ((symbol RAL_old) (entry_date 2017-08-03)
       (detail
