((checks
    ...
    (specimens
     (((symbol VRNS) (entry_date 2021-07-21)
      ...
      ((symbol PLAB) (entry_date 2019-10-22)
       (detail "prior_top=12.78 within +25% of entry=11.71"))
      ...
      ((symbol ISRG) (entry_date 2021-05-04)
       (detail "prior_top=291.84 within +25% of entry=282.52")))))
   ...
   ((id V12) (severity Invariant) (passed false) (n_violations 5)
    ...
    (specimens
     (((symbol ISRG) (entry_date 2021-05-04)
      ...
      ((symbol HLX) (entry_date 2023-07-29)
       (detail
        "installed_stop=7.8750 vs fill=9.3900 -> dist=0.1613 > gate=0.1500"))
      ((symbol CNDT) (entry_date 2021-06-08)
       (detail
        "installed_stop=6.8750 vs fill=8.0900 -> dist=0.1502 > gate=0.1500"))
   ...
   ((id V13) (severity Invariant) (passed false) (n_violations 36)
    ...
    (specimens
     (((symbol SPF) (entry_date 2019-09-07)
      ...
      ((symbol PFSI) (entry_date 2019-07-31)
       (detail
        "entry_price=24.6600 outside 2019-07-31 bar [24.0000, 24.6550]"))
      ((symbol OMF) (entry_date 2019-08-14)
       (detail
 ...
 (audit_join ((matched 178) (total 178))))
