;; Item-4 confirmation-grid cell (a4-2019): the a0-breadth-on-null spec with period/universe moved to the 2019 vintage + the two cadence overrides (initial_stop_buffer 0.9167, stop_update_cadence Weekly).
;; Runs on /tmp/snap_top3000_2019_v10dedup in the pinned worktree sweep-detgate. NOT a golden — staging scenario.
((name "a4-2019")
 (description "Grid arm, 2019 vintage 5y: n5-2019 + initial_stop_buffer 0.9167 + stop_update_cadence Weekly.")
