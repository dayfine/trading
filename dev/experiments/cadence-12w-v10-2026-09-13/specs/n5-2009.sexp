;; Item-4 confirmation-grid cell (n5-2009): the a0-breadth-on-null spec with period/universe moved to the 2009 vintage.
;; Runs on /tmp/snap_top3000_2009_v10dedup in the pinned worktree sweep-detgate. NOT a golden — staging scenario.
((name "n5-2009")
 (description "Grid null, 2009 vintage 5y: record convention + breadth_direction read ON (inert), on _v10dedup 2009.")
