;; Item-4 confirmation-grid cell (n5-2019): the a0-breadth-on-null spec with period/universe moved to the 2019 vintage.
;; Runs on /tmp/snap_top3000_2019_v10dedup in the pinned worktree sweep-detgate. NOT a golden — staging scenario.
((name "n5-2019")
 (description "Grid null, 2019 vintage 5y: record convention + breadth_direction read ON (inert), on _v10dedup 2019.")
