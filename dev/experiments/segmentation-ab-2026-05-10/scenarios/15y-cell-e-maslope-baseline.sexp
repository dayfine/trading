;; A/B Cell E 15y: baseline MaSlope stage classifier. Should reproduce the
;; cell-e-15y-2026-05-07 result on the post-#1019 simulator.
((name "15y-cell-e-maslope-baseline")
 (description
   "15y Cell E (Stage3 K=1 + Laggard h=2) — MaSlope stage classifier (default).")
