...
((name "grid1-g2a1")
 (description "FUNDING GRID arm — fullbook-graded base + G2a retries 1. Internal three-way comparison (plan ticket-funding-2026-08-16 step 4); judge event-level on saved tickets, not top-line.")
