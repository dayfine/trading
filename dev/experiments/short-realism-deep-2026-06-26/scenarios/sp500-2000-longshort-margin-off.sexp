...
;; ((margin_config ((enabled false)))). Universe sp500-historical/sp500-2000-01-01
;; (515 PIT-2000 symbols), CSV mode (N=515 fits without snapshot mode).
((name "sr-sp500-2000-longshort-margin-off")
 (description "sp500-515 PIT-2000 long-short, 2000-2026, Cell-E + short_min_price 17, margin OFF (free-leverage baseline).")
