...
;; This is the MARGIN-ON twin (Reg-T 150% collateral lock at entry, 50bps borrow
;; fee, 25% maintenance, force-liquidation on margin call — issue #859 Phase 1+2).
;; Compare bottom-line + trade records against the -margin-off twin to measure
;; whether the merged margin model deflates the inflated long-short absolute return
;; and keeps NAV non-negative AT BREADTH. See
...
;; diff vs the -off twin is ((margin_config ((enabled true)))).
...
((name "sr-broad-top3000-1998-longshort-margin-on")
 (description "top-3000 PIT-1998 long-short, 1998-2026, Cell-E + short_min_price 17, margin ON (Reg-T collateral + maintenance + force-liq).")
