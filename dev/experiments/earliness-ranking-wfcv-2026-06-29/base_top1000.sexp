((name "candrank-base-top1000")
 (description "Cell-E broad top-1000 PIT-1998 long-only base; candidate-ranking (Alphabetical vs Quality tiebreak) WF-CV surface. Clone of declining-ma-wfcv base; only the variant axis differs.")
 (period ((start_date 2000-01-01) (end_date 2026-04-30)))
 (universe_path "goldens-custom-universe/composition/top-1000-1998.sexp")
 (universe_size 1000)
 (config_overrides
