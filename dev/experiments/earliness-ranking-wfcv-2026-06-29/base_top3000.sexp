((name "candrank-base-top3000")
 (description "Cell-E broad top-3000 PIT-1998 long-only base; candidate-ranking (Alphabetical vs Quality tiebreak) WF-CV grid cell (broad breadth — where over-subscription bites hardest).")
