...
;; 15y baseline + enable_stage3_force_exit = true, hysteresis_weeks = 3.
((name "sp500-15y-stage3-on-h3")
 (description "15y SP500 historical + Stage-3 force-exit ON, hysteresis_weeks=3")
