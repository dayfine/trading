...
;; 5y baseline = sp500-2019-2023 + enable_stage3_force_exit = true, hysteresis_weeks = 2 (default).
...
((name "sp500-5y-stage3-on-h2")
 (description "5y SP500 + Stage-3 force-exit ON, hysteresis_weeks=2 (default)")
