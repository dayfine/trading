...
;; 15y baseline + enable_stage3_force_exit = true, hysteresis_weeks = 2 (default).
((name "sp500-15y-stage3-on-h2")
 (description "15y SP500 historical + Stage-3 force-exit ON, hysteresis_weeks=2 (default)")
