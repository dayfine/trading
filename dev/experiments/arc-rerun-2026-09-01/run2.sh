...
PIN=deb45a7ee
WT=/workspaces/trading-1/.claude/worktrees/sweep-arc0901
ROOT=$WT/trading
HOST_WT="$REPO/.claude/worktrees/sweep-arc0901"
...
run_cell arc26y
run_cell b5-arc-dup
run_cell b5-arc-novol
run_cell b5-arc-macross
run_cell b5-fullbook
run_cell b5-arc-anchor26
log "LADDER DONE — pausing for agent wave if /tmp/arc0901.pause exists"
while [ -f /tmp/arc0901.pause ]; do sleep 60; done
run_cell arc26y-novol
log "ARC0901 CHAIN DONE"
