...
;;
;; Margin-ON twin of gfc-2008-2009-margin-off.sexp. See sibling -off.sexp
;; for full context.
((name "margin-phase3-gfc-2008-2009-on")
 (description
   "2007-10-01..2009-03-31 GFC bear (broad-1000-30y), Cell E config, margin_config.enabled=true (Phase 1+2 wiring active)")
