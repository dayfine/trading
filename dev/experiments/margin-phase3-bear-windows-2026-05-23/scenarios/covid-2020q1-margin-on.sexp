...
;;
;; Margin-ON twin of covid-2020q1-margin-off.sexp. See sibling -off.sexp
;; for full context.
((name "margin-phase3-covid-2020q1-on")
 (description
   "2020-01-02..2020-06-30 COVID Q1 crash (sp500-2010-01-01), Cell E config, margin_config.enabled=true (Phase 1+2 wiring active)")
