...
;;
;; Margin-OFF baseline for the 2022 bear window. See sibling -on.sexp
;; for the margin-flag-active twin. 2022 is the cleanest modern bear
;; for this experiment because the 16y long-short golden (PR #1066)
;; already uses the same 2010-cohort universe — the metric delta
;; observed here on the windowed run informs whether Phase 5's
;; long-short re-pin will move under margin-on.
((name "margin-phase3-bear-2022-off")
 (description
   "2022-01-01..2022-10-31 modern bear (sp500-2010-01-01), Cell E config, margin_config.enabled=false (baseline)")
