;; Cell E h=2 sweep: max_position_pct_long = 0.20 (~2-3 max positions at 0.50
;; long exposure). 15y. Maximum-conviction variant — most concentrated knob in
;; this sweep. Risk: single-name drawdowns hit harder; rotation may starve
;; if all slots full.
((name "cell-e-15y-maxpos-0.20")
 (description "Cell E h=2 — 15y — max_position_pct_long=0.20 (~2-3 max positions)")
