;; Cell E h=2 sweep B: 0.14 / 0.70 / 0.30 → ~5 max positions, 70% long, 0% idle.
((name "cell-e-15y-maxpos-0.14-exp0.70")
 (description "Cell E h=2 — 15y — 0.14 pos / 0.70 long exposure (~5 positions, 0% idle)")
