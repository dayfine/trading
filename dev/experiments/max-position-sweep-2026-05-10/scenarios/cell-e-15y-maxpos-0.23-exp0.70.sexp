;; Cell E h=2 sweep B: 0.23 / 0.70 / 0.30 → ~3 max positions, 70% long, 0% idle.
((name "cell-e-15y-maxpos-0.23-exp0.70")
 (description "Cell E h=2 — 15y — 0.23 pos / 0.70 long exposure (~3 positions, 0% idle)")
 (period ((start_date 2010-01-01) (end_date 2024-12-31)))
 (universe_path "universes/sp500-historical/sp500-2010-01-01.sexp")
 (universe_size 510)
 (config_overrides
  (((enable_short_side false))
   ((portfolio_config ((max_position_pct_long 0.23))))
