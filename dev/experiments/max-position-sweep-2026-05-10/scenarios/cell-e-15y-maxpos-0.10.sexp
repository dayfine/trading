;; Cell E h=2 sweep: max_position_pct_long = 0.10 (~5 max positions at 0.50
;; long exposure). 15y. User's "5-7 positions at $100k" lower bound.
((name "cell-e-15y-maxpos-0.10")
 (description "Cell E h=2 — 15y — max_position_pct_long=0.10 (~5 max positions)")
