...
((name "t1-topn-30-sub")
 (description "Grid arm: a0-pit-null + screening_config.max_buy_candidates 20 -> 30 on the 2019-2025 sub-window; pairs against a0-pit-null-sub at the same salt")
 ...
 (config_overrides
  (((enable_sim_entry_stoplimit true)) ((entry_order_max_rest_weeks 0))
   ...
   ((screening_config ((max_buy_candidates 30))))))
