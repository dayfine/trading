;; Top-N confirmation grid, sub-window cell (dev/experiments/top-n-grid-2026-09-22): the a0-pit-null config on
;; the 2019-01-01..2025-12-31 sub-window of the same 27-entry PIT universe_schedule (D1/D2 dating unchanged).
;; Runs on /tmp/snap_top3000_pit_v11pit. Pre-registered before any cell ran (README §Decision rule).
;; NOT a golden - staging scenario.
((name "t1-topn-40-sub")
 (description "Grid arm: a0-pit-null + screening_config.max_buy_candidates 20 -> 40 on the 2019-2025 sub-window (the #2900 value); pairs against a0-pit-null-sub at the same salt")
 (period ((start_date 2019-01-01) (end_date 2025-12-31)))
