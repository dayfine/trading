...
((name "a0-pit-null-sub")
 (description "Grid null: a0-pit-null unchanged (max_buy_candidates 20) on the 2019-2025 sub-window; the paired base for every t1-topn-*-sub cell at the same salt")
