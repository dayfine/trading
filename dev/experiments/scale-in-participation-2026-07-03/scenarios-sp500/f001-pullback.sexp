;; Participation-effect measurement: sp500 fold-001 pullback@0.5 (v1 defaults).
;; Re-run on current main (repro ran pre-#1837 commit b63bd8b — avoid version skew).
((name "part-sp500-f001-pullback")
 (description "Participation measurement: sp500 fold-001 (2001-12-31..2003-12-30) scale-in pullback, fraction 0.5.")
