...
let test_sma_basic _ =
  let data =
    [ v "2024-01-01" 10.0; v "2024-01-02" 20.0; v "2024-01-03" 30.0 ]
  in
...
let test_sma_empty _ = assert_that (calculate_sma [] 3) is_empty

let test_sma_preserves_dates _ =
  (* Weekly data — verifies non-daily intervals are handled correctly *)
  let data =
    [ v "2024-01-01" 10.0; v "2024-01-08" 20.0; v "2024-01-15" 30.0 ]
  in
