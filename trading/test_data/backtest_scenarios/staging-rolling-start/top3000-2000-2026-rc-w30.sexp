...
((name "top3000-2000-2026-rc-w30")
 (description "28y record convention + overhead_supply armed, w_overhead_supply=30 (grid-robust value; rolling-start promotion lens).")
