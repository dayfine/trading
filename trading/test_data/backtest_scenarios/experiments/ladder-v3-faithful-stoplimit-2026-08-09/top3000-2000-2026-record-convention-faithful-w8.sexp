;; LADDER V3 — faithful-StopLimit arm, 8-week local-range anchor.
;; The book ticket done RIGHT per dev/plans/entry-ticket-right-basis-2026-08-08.md:
;; resting StopLimit at the top of the CURRENT trading range (8w local top, not
...
((name "top3000-2000-2026-record-convention-faithful-w8")
 (description "Faithful StopLimit ticket: 8w local-range trigger + frozen E + next-open fills + support-floor stop (15% as filter). Ladder v3 arm.")
