;; LADDER V4 — cell 16 "rt-ttl4-nearfloor-volconf": composed FLAGSHIP — F1 + 4-week TTL + nearest-floor + F5, all at the book's 15% gate.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=true
;; The fully-faithful composed cell: every armed mechanism is book-supported and NO diagnostic knob is on. This is the arm that answers whether asynchronous-ticket process fidelity alone closes any of the ladder-v3 gap. If it does not, plan §5's stop rule applies — re-dissect, do not knob-search.
;;
...
((name "top3000-2000-2026-v4-16-rt-ttl4-nearfloor-volconf")
 (description "Ladder v4 cell 16 (rt-ttl4-nearfloor-volconf): anchor=4w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=true. composed FLAGSHIP — F1 + 4-week TTL + nearest-floor + F5, all at the book's 15% gate.")
