;; LADDER V4 — cell 22 "rt-volconf-sizedown50-diag": composed — F1 + F5 + F3 Size_down at a 0.50 ceiling, no TTL. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=0w width=Sizedown@0.50-diag volume_confirm=true
;; DIAGNOSTIC-ONLY per plan §5. Maximum tail-participation probe: widest admission (Size_down) with volume judged at the fill and no TTL recycling. Bounds what the whole v4 mechanism set can capture; not a promotion candidate.
;;
...
((name "top3000-2000-2026-v4-22-rt-volconf-sizedown50-diag")
 (description "Ladder v4 cell 22 (rt-volconf-sizedown50-diag): anchor=4w freshness=Range_top_breakout ttl=0w width=Sizedown@0.50-diag volume_confirm=true. composed — F1 + F5 + F3 Size_down at a 0.50 ceiling, no TTL. DIAGNOSTIC-ONLY.")
