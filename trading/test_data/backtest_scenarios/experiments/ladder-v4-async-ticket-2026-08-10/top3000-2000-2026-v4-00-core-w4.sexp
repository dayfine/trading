;; LADDER V4 — cell 00 "core-w4": the v2-core cell — every v4 knob at its no-op.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.15 volume_confirm=false
;; Reference cell. Reproduces the ladder-v3 faithful-w4 arm (+318%) bit-for-bit; every Stage-A delta below is measured against THIS cell, so a drift here invalidates the whole ladder.
;;
...
((name "top3000-2000-2026-v4-00-core-w4")
