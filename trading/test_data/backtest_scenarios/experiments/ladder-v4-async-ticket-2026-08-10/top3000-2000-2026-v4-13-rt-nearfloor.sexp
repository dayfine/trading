;; LADDER V4 — cell 13 "rt-nearfloor": composed — F1 range-top freshness + nearest-floor stop anchor.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=0w width=Nearest@0.15 volume_confirm=false
;; Both changes are book-supported: the §1 Stage-2 start event plus the §5.1 nearest-correction-low remedy. No diagnostic knob is armed in this cell.
;;
...
((name "top3000-2000-2026-v4-13-rt-nearfloor")
 (description "Ladder v4 cell 13 (rt-nearfloor): anchor=4w freshness=Range_top_breakout ttl=0w width=Nearest@0.15 volume_confirm=false. composed — F1 range-top freshness + nearest-floor stop anchor.")
