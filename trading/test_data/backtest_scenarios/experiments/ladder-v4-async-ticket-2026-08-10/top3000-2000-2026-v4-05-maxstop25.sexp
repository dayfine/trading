;; LADDER V4 — cell 05 "maxstop25": width axis delta — max_stop_distance_pct 0.15 -> 0.25 (F4 sweep).
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.25 volume_confirm=false
;; Measures where the §5.1 exclusion binds. 0.25 already deviates from the book's 15% and is NOT a promotion candidate without a documented deviation argument.
;;
...
((name "top3000-2000-2026-v4-05-maxstop25")
 (description "Ladder v4 cell 05 (maxstop25): anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.25 volume_confirm=false. width axis delta — max_stop_distance_pct 0.15 -> 0.25 (F4 sweep).")
