;; LADDER V4 — cell 07 "maxstop50-diag": width axis delta — max_stop_distance_pct 0.50. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.50-diag volume_confirm=false
;; DIAGNOSTIC-ONLY per plan §5/§3-F4. 0.50 clears AXTI's 36.2% trigger-basis stop distance (ladder-v3 dissection), so this cell bounds the maximum tail participation the width axis alone can buy. Not a promotion candidate under any book reading.
;;
...
((name "top3000-2000-2026-v4-07-maxstop50-diag")
 (description "Ladder v4 cell 07 (maxstop50-diag): anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.50-diag volume_confirm=false. width axis delta — max_stop_distance_pct 0.50. DIAGNOSTIC-ONLY.")
