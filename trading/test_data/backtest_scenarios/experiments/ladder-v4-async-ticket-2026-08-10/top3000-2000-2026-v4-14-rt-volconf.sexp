;; LADDER V4 — cell 14 "rt-volconf": composed — F1 range-top freshness + F5 volume-confirm-at-fill.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=true
;; The pure process-fidelity pair: the book's Stage-2 start event plus judging volume at the breakout instead of at screen time. Tests plan prediction 4 (fewer false-breakout stop-outs at small return cost).
;;
...
((name "top3000-2000-2026-v4-14-rt-volconf")
 (description "Ladder v4 cell 14 (rt-volconf): anchor=4w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=true. composed — F1 range-top freshness + F5 volume-confirm-at-fill.")
