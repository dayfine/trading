;; LADDER V4 — cell 08 "sizedown50-diag": width axis delta — F3 Size_down with a 0.50 sanity ceiling. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Sizedown@0.50-diag volume_confirm=false
;; DIAGNOSTIC-ONLY per plan §5. F3 Size_down is an honestly-labelled tolerated-participation READING of §5.1, not a documented book mechanism — the book's remedies are nearest-floor anchoring, the trader 4-6% stop, or passing. Cell 09 is its faithful rival.
;;
...
((name "top3000-2000-2026-v4-08-sizedown50-diag")
 (description "Ladder v4 cell 08 (sizedown50-diag): anchor=4w freshness=Ma_cross ttl=0w width=Sizedown@0.50-diag volume_confirm=false. width axis delta — F3 Size_down with a 0.50 sanity ceiling. DIAGNOSTIC-ONLY.")
