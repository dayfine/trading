;; LADDER V4 — cell 15 "rt-ttl4-nearfloor": composed — F1 + 4-week TTL + nearest-floor stop anchor.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=false
;; The faithful triple, volume still judged at placement. Isolates F5's marginal contribution when read against cell 16.
;;
...
((name "top3000-2000-2026-v4-15-rt-ttl4-nearfloor")
 (description "Ladder v4 cell 15 (rt-ttl4-nearfloor): anchor=4w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=false. composed — F1 + 4-week TTL + nearest-floor stop anchor.")
