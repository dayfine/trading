;; LADDER V4 — cell 12 "rt-ttl4": composed — F1 range-top freshness + 4-week TTL.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.15 volume_confirm=false
;; The two asynchronous-ticket mechanisms (M1 clock + M2 place-then-wait discipline) together, with the width gate untouched at the book's 15%.
;;
...
((name "top3000-2000-2026-v4-12-rt-ttl4")
 (description "Ladder v4 cell 12 (rt-ttl4): anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.15 volume_confirm=false. composed — F1 range-top freshness + 4-week TTL.")
