;; LADDER V4 — cell 09 "nearfloor": width axis delta — support_floor_anchor_scope Nearest (the faithful rival to F3).
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Nearest@0.15 volume_confirm=false
;; Shrinks stop DISTANCE the book's own way (anchor at the nearest qualifying correction low) instead of shrinking the share count, while keeping the 15% gate intact. The faithful counterpart to cell 08.
;;
...
((name "top3000-2000-2026-v4-09-nearfloor")
 (description "Ladder v4 cell 09 (nearfloor): anchor=4w freshness=Ma_cross ttl=0w width=Nearest@0.15 volume_confirm=false. width axis delta — support_floor_anchor_scope Nearest (the faithful rival to F3).")
