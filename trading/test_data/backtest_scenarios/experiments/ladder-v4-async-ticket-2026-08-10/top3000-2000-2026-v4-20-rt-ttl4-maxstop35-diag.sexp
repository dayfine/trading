;; LADDER V4 — cell 20 "rt-ttl4-maxstop35-diag": composed — F1 + 4-week TTL + a 0.35 width gate. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.35-diag volume_confirm=false
;; DIAGNOSTIC-ONLY per plan §5. Extends cell 19's exclusion probe far enough to admit most crash-recovery geometry. Read for WHERE the gate binds, never as a candidate default.
;;
...
((name "top3000-2000-2026-v4-20-rt-ttl4-maxstop35-diag")
 (description "Ladder v4 cell 20 (rt-ttl4-maxstop35-diag): anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.35-diag volume_confirm=false. composed — F1 + 4-week TTL + a 0.35 width gate. DIAGNOSTIC-ONLY.")
