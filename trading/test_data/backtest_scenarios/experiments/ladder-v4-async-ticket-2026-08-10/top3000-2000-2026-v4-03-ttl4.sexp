;; LADDER V4 — cell 03 "ttl4": TTL axis delta — resting tickets cancel after 4 unfilled weeks.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=4w width=Drop@0.15 volume_confirm=false
;; F2 backstop clock only; the primary condition-based re-screen cancel is always active once ttl > 0. Tests plan prediction 1 (fewer fills, less backfill churn).
;;
...
((name "top3000-2000-2026-v4-03-ttl4")
 (description "Ladder v4 cell 03 (ttl4): anchor=4w freshness=Ma_cross ttl=4w width=Drop@0.15 volume_confirm=false. TTL axis delta — resting tickets cancel after 4 unfilled weeks.")
