;; LADDER V4 — cell 02 "fresh-rangetop": freshness axis delta — F1 clock from the range-top breakout, not the MA cross.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=false
;; Tests plan prediction 3: M1 (stage clock starting at the MA cross) is the binding exclusion for AXTI-class bases, so this single axis should move composition more than TTL does.
;;
...
((name "top3000-2000-2026-v4-02-fresh-rangetop")
 (description "Ladder v4 cell 02 (fresh-rangetop): anchor=4w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=false. freshness axis delta — F1 clock from the range-top breakout, not the MA cross.")
