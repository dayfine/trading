;; LADDER V4 — cell 04 "ttl8": TTL axis delta — resting tickets cancel after 8 unfilled weeks.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=8w width=Drop@0.15 volume_confirm=false
;; The looser TTL cell. Plan §3-F2 flags long no-revalidation windows as the least book-like end of this dial; 8w brackets 4w from above.
;;
...
((name "top3000-2000-2026-v4-04-ttl8")
 (description "Ladder v4 cell 04 (ttl8): anchor=4w freshness=Ma_cross ttl=8w width=Drop@0.15 volume_confirm=false. TTL axis delta — resting tickets cancel after 8 unfilled weeks.")
