;; LADDER V4 — cell 17 "rt-ttl8-nearfloor-volconf": composed — the flagship with an 8-week TTL instead of 4.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=8w width=Nearest@0.15 volume_confirm=true
;; TTL robustness of the flagship. A large flagship-vs-this gap would mean the result is a TTL artifact rather than process fidelity.
;;
...
((name "top3000-2000-2026-v4-17-rt-ttl8-nearfloor-volconf")
 (description "Ladder v4 cell 17 (rt-ttl8-nearfloor-volconf): anchor=4w freshness=Range_top_breakout ttl=8w width=Nearest@0.15 volume_confirm=true. composed — the flagship with an 8-week TTL instead of 4.")
