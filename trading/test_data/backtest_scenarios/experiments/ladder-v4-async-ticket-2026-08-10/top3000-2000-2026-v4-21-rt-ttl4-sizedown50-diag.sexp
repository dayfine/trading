;; LADDER V4 — cell 21 "rt-ttl4-sizedown50-diag": composed — F1 + 4-week TTL + F3 Size_down at a 0.50 ceiling. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Sizedown@0.50-diag volume_confirm=false
;; DIAGNOSTIC-ONLY per plan §5. The tolerated-participation reading composed with the asynchronous mechanics; its faithful rival is cell 15. Plan §6 risk: audit the Sized_down_wide_stop share counts for positions rounding to zero under min-notional / liquidity gates.
;;
...
((name "top3000-2000-2026-v4-21-rt-ttl4-sizedown50-diag")
 (description "Ladder v4 cell 21 (rt-ttl4-sizedown50-diag): anchor=4w freshness=Range_top_breakout ttl=4w width=Sizedown@0.50-diag volume_confirm=false. composed — F1 + 4-week TTL + F3 Size_down at a 0.50 ceiling. DIAGNOSTIC-ONLY.")
 ...
 (config_overrides
  (;; --- v2-core base (verbatim from the ladder-v3 faithful arm) ---
   ...
   ((stop_width_size_down_max_pct 0.50))
