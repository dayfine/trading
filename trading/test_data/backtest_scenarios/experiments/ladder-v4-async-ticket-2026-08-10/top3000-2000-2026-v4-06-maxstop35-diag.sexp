;; LADDER V4 — cell 06 "maxstop35-diag": width axis delta — max_stop_distance_pct 0.35. DIAGNOSTIC-ONLY.
...
;; v4 coordinate: anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.35-diag volume_confirm=false
;; DIAGNOSTIC-ONLY per plan §5/§3-F4: promoting 0.35 would be an explicit, documented deviation from book §5.1's 15% (and §5.3's trader preset is 4-6%). It exists to measure where the exclusion binds, never to become a default.
;;
...
((name "top3000-2000-2026-v4-06-maxstop35-diag")
 (description "Ladder v4 cell 06 (maxstop35-diag): anchor=4w freshness=Ma_cross ttl=0w width=Drop@0.35-diag volume_confirm=false. width axis delta — max_stop_distance_pct 0.35. DIAGNOSTIC-ONLY.")
 ...
 (config_overrides
  (;; --- v2-core base (verbatim from the ladder-v3 faithful arm) ---
   ...
   ((stops_config ((max_stop_distance_pct 0.35))))
