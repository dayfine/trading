;; LADDER V4 — cell 11 "anchor-w8-rangetop": anchor x freshness interaction — 8-week anchor with the F1 range-top clock.
...
;; v4 coordinate: anchor=8w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=false
;; F1's admit rule and the resting ticket MUST reference the same level (plan §6, last bullet), so the anchor window changes the freshness test as well as the trigger. This cell separates that interaction from cells 01 and 02.
;;
...
((name "top3000-2000-2026-v4-11-anchor-w8-rangetop")
 (description "Ladder v4 cell 11 (anchor-w8-rangetop): anchor=8w freshness=Range_top_breakout ttl=0w width=Drop@0.15 volume_confirm=false. anchor x freshness interaction — 8-week anchor with the F1 range-top clock.")
