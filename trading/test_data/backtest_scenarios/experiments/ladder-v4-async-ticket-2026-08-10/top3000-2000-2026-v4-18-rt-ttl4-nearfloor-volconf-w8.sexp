;; LADDER V4 — cell 18 "rt-ttl4-nearfloor-volconf-w8": composed — the flagship at the 8-week anchor.
...
;; v4 coordinate: anchor=8w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=true
;; Anchor robustness of the flagship, within the TRUNCATED {4,8} axis noted above. Neither window is the book's base-extent anchor, so agreement here is weak evidence of anchor-insensitivity, not proof.
;;
...
((name "top3000-2000-2026-v4-18-rt-ttl4-nearfloor-volconf-w8")
 (description "Ladder v4 cell 18 (rt-ttl4-nearfloor-volconf-w8): anchor=8w freshness=Range_top_breakout ttl=4w width=Nearest@0.15 volume_confirm=true. composed — the flagship at the 8-week anchor.")
