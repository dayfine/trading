;; LADDER V4 — cell 19 "rt-ttl4-maxstop25": composed — F1 + 4-week TTL + a 0.25 width gate.
...
;; v4 coordinate: anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.25 volume_confirm=false
;; Separates 'the process was wrong' from 'the width gate excluded the population': same asynchronous mechanics as cell 12 with the gate loosened one notch. 0.25 is not a promotion candidate without a documented §5.1 deviation.
;;
...
((name "top3000-2000-2026-v4-19-rt-ttl4-maxstop25")
 (description "Ladder v4 cell 19 (rt-ttl4-maxstop25): anchor=4w freshness=Range_top_breakout ttl=4w width=Drop@0.25 volume_confirm=false. composed — F1 + 4-week TTL + a 0.25 width gate.")
