;; M5.6 cost-model slippage sweep — Cell 5bps (light retail-broker model).
;; See cell-00bps.sexp for the Cell E config rationale and pinned baseline.
((name "m5-6-slippage-cell-05bps")
 (description "M5.6 slippage sweep — 5 bps (light retail-broker model, ~IBKR Tiered)")
