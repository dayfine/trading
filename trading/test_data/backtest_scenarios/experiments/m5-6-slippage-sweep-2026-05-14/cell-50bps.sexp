;; M5.6 cost-model slippage sweep — Cell 50bps (stress test, panic-regime / small-cap).
;; See cell-00bps.sexp for the Cell E config rationale and pinned baseline.
((name "m5-6-slippage-cell-50bps")
 (description "M5.6 slippage sweep — 50 bps (stress test, panic / small-cap floor)")
