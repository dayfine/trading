;; M5.6 cost-model slippage sweep — Cell 10bps (mid-tier "realistic floor").
;; See cell-00bps.sexp for the Cell E config rationale and pinned baseline.
((name "m5-6-slippage-cell-10bps")
 (description "M5.6 slippage sweep — 10 bps (mid-tier realistic floor)")
