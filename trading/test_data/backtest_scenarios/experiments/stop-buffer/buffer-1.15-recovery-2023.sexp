;; Stop-buffer experiment: 15% buffer (initial_stop_buffer = 1.15)
;; This is the book maximum per Weinstein Ch. 6.
((name "stop-buffer-1.15-recovery-2023")
 (description "Stop buffer 1.15 (15% below support) on 2023 recovery period")
