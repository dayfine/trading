;; Stop-buffer experiment: 12% buffer (initial_stop_buffer = 1.12)
((name "stop-buffer-1.12-recovery-2023")
 (description "Stop buffer 1.12 (12% below support) on 2023 recovery period")
