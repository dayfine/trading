((name "inspect-6mo-bothfix")
 (description "BOTHFIX — bookstop (initial_stop_buffer 1.0) + volume_confirm_at_fill OFF: bounds what fixing the eject basis could recover on top of the book-band stop.")
