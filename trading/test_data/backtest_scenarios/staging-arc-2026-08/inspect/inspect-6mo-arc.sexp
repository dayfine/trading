((name "inspect-6mo-arc")
 (description "INSPECTION arm — the full arc bundle (anchor 4wk + rt + StopLimit 2pp + volconf + base-stop), 6mo 2019H1, non-binding metrics: exists to produce trades and audit records for defect dissection.")
