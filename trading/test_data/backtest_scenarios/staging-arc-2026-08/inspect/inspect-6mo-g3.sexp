((name "inspect-6mo-g3")
 (description "INSPECTION arm — arc bundle plus reserve_cash_for_resting_tickets true (G3, first arming anywhere): does placement-time reservation eliminate the Insufficient-cash rejections, and at what idle-cash cost. Liveness + audit inspection, non-binding metrics.")
