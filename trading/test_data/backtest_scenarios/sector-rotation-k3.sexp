...
;;
;; Strategy: [Sector_rotation_weinstein (k 3) (ma_period_weeks 30)] — see
...
((name "sector-rotation-k3")
 (description "Sector-rotation Weinstein investor preset (30wk MA, long/flat), K=1 — top-3 Stage-2 SPDR sectors by RS vs SPY, 2009-06-01 to 2025-12-31.")
