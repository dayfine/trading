;; RE-MEASURE LADDER — local-top-E arm (26w range, band 2pp). Identical to
...
((name "top3000-2000-2026-record-convention-localtop26")
 (description "Record convention + E-anchored StopLimit band 2pp + LOCAL-RANGE-TOP anchor 26w (#2217 entry_anchor_local_range_weeks; re-measure ladder arm).")
