;; RE-MEASURE LADDER — local-top-E arm (52w range, band 2pp). Identical to
...
((name "top3000-2000-2026-record-convention-localtop52")
 (description "Record convention + E-anchored StopLimit band 2pp + LOCAL-RANGE-TOP anchor 52w (#2217 entry_anchor_local_range_weeks; re-measure ladder arm).")
 ...
 (config_overrides
  (((enable_sim_entry_stoplimit true))
   ...
   ((entry_anchor_local_range_weeks 52))
