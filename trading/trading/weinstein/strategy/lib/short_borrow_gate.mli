...
(** Strategy-side adapter: builds the [dollar_adv_for] lookup from [bar_reader]
    via {!Liquidity_metric.dollar_adv} over [liquidity_config.adv_lookback_days]
    of bars available at [current_date] (no lookahead), then delegates to
    {!filter}. No-op at [min_dollar_adv <= 0.0].
